            ...
            <div className="flex flex-col gap-4 mb-8 sm:mb-10">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <p className="text-sm sm:text-[15px] font-medium text-slate-500">
                        Managing sprints and high-level architecture.
                    </p>
                    <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
                        <div className="flex items-center gap-2 px-4 py-2 bg-white border border-emerald-100 rounded-xl shadow-sm shadow-emerald-50/50 w-fit">
                            <div className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" />
                            <span className="text-[10px] sm:text-[11px] font-extrabold text-emerald-600 uppercase tracking-widest">Senior Developer</span>
                        </div>
