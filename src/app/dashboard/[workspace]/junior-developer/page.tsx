...
export default async function JuniorDevDashboard({ params }: { params: Promise<{ workspace: string }> }) {
            ...
            <div className="flex flex-col gap-4 mb-8 sm:mb-10">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <p className="text-sm sm:text-[15px] font-medium text-slate-500">
                        Focused on coding and continuous learning.
                    </p>
                    <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
                        <div className="flex items-center gap-2 px-4 py-2 bg-white border border-blue-100 rounded-xl shadow-sm shadow-blue-50/50 w-fit">
                            <div className="w-1.5 h-1.5 rounded-full bg-blue-500 animate-pulse" />
                            <span className="text-[10px] sm:text-[11px] font-extrabold text-blue-600 uppercase tracking-widest">Junior Developer</span>
                        </div>
